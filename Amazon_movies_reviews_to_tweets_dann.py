...
seq_length = (Amz_movies_AVG_document_length + tweets_AVG_document_length) // 2

print(seq_length)
# Build vocabulary
vocab_processor_amazon = learn.preprocessing.VocabularyProcessor(seq_length)
Amz_movies_x = np.array(list(vocab_processor_amazon.fit_transform(Amz_movies_x_text)))
    ...
    def _build_model(self):
        ...
        with tf.variable_scope('feature_extractor'):
            cnn = TextCNN(self.X,self.y,
                ...
                vocab_size=len(vocab_processor_amazon.vocabulary_),
                embedding_size=128,
