...
#tweets_x_text = tweets_x_text[:-40000]
#tweets_y = tweets_y[:-40000]
...
num_test = 500
combined_test_txt = np.vstack([Amz_movies_x_test[:num_test], Amz_movies_x_test[:num_test]])
combined_test_labels = np.vstack([IMDB_y_test[:num_test], IMDB_y_test[:num_test]]) # they use hte labels of hte source domian dataset with the target domain dataset
